...
/**
 * A memory-resident {@link HermesOutput} implementation.
 *
 * @lucene.internal
 */
public class RAMOutputStream extends HermesOutput implements Accountable {
  ...
  public void writeTo(HermesOutput out) throws IOException {
    flush();
