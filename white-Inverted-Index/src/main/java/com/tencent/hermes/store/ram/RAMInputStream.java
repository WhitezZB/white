 ...
 */
package com.tencent.hermes.store.ram;
...
import static com.tencent.hermes.store.ram.RAMOutputStream.BUFFER_SIZE;
 
public class RAMInputStream extends HermesInput implements Cloneable {
  ...
  @Override
  public HermesInput slice(String sliceDescription, final long offset, final long sliceLength) throws IOException {
    ...
    return new RAMInputStream(getFullSliceDescription(sliceDescription), file, offset + sliceLength) {
      ...
      @Override
      public HermesInput slice(String sliceDescription, long ofs, long len) throws IOException {
