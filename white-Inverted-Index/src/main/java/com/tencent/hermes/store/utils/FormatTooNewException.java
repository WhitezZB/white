 ...
 */
public class FormatTooNewException extends IOException {
   ...
   *
   * @lucene.internal */
  public FormatTooNewException(String resourceDescription, int version, int minVersion, int maxVersion) {
   ...
   *
   * @lucene.internal */
  public FormatTooNewException(DataInput in, int version, int minVersion, int maxVersion) {
