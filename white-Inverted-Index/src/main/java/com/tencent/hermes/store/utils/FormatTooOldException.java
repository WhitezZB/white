 ...
 */
public class FormatTooOldException extends IOException {
   ...
   *
   * @lucene.internal */
  public FormatTooOldException(String resourceDescription, String reason) {
   ...
   *
   * @lucene.internal */
  public FormatTooOldException(DataInput in, String reason) {
   ...
   * 
   * @lucene.internal */
  public FormatTooOldException(String resourceDescription, int version, int minVersion, int maxVersion) {
    super("Format version is not supported (resource " + resourceDescription + "): " +
   ...
   *
   * @lucene.internal */
  public FormatTooOldException(DataInput in, int version, int minVersion, int maxVersion) {
