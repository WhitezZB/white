 ...
 * @see Directory
 */
public abstract class HermesInput extends DataInput implements Cloneable,Closeable {
   ...
   *  {@link #toString}. */
  protected HermesInput(String resourceDescription) {
  ...
  public HermesInput clone() {
    return (HermesInput) super.clone();
  }
   ...
   */
  public abstract HermesInput slice(String sliceDescription, long offset, long length) throws IOException;
  ...
  public RandomAccessInput randomAccessSlice(long offset, long length) throws IOException {
    final HermesInput slice = slice("randomaccess", offset, length);
    if (slice instanceof RandomAccessInput) {
      ...
      return new RandomAccessInput() {
        ...
        @Override
        public String toString() {
          return "RandomAccessInput(" + HermesInput.this.toString() + ")";
        }
      };
    }
  }
