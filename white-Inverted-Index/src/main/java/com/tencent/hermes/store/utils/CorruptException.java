...
public class CorruptException extends IOException {
  ...
  public CorruptException(String message, DataInput input) {
    this(message, input, null);
  }

  /** Create exception with a message only */
  public CorruptException(String message, HermesOutput output) {
    this(message, output, null);
  }
  
  /** Create exception with message and root cause. */
  public CorruptException(String message, DataInput input, Throwable cause) {
    this(message, Objects.toString(input), cause);
  }

  /** Create exception with message and root cause. */
  public CorruptException(String message, HermesOutput output, Throwable cause) {
    this(message, Objects.toString(output), cause);
  }
  
  /** Create exception with a message only */
  public CorruptException(String message, String resourceDescription) {
    this(message, resourceDescription, null);
  }
  
  /** Create exception with message and root cause. */
  public CorruptException(String message, String resourceDescription, Throwable cause) {
