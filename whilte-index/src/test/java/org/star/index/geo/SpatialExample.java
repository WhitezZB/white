...
public class SpatialExample {  
    ...
    private void indexPoints() throws Exception {  
        ...
        while ((line = br.readLine()) != null) {  
            ...
            Point point = this.ctx.makePoint(shopBean.getLongitude(), shopBean.getLatitude());
            Document document = newSampleDocument(shopBean.getId(), shopBean.getName(), point );  
